...
module.exports = {
  ...
  * @param {Number} phoneNumber Graduate phone number
  */
 ...
 /*
  * Create University participant in Blockchain and Firebase
  * To be used just by Admin
  ...
  * @param {String} shortName University shortName
  * @param {String} fullName University fullName
 ...
 registerUniversityInBlockchainAndFirebase: async function(cardId, universityRut, shortName, fullName, email) {
  try {
   ...
   //CHECK IF UNIVERSITY EXISTS IN BOTH BLOCKCHAIN AND FIREBASE?
   ...
   //IF STATEMENT TO REGISTER UNIVERSITY DEPENDING ON checkFirebase AND checkBlockchain returned values
   if (checkBlockchain != true && checkFirebase != true) {

    //NOT REGISTERED IN NEATHER BOTH OF THEM
    ...
    //IF IS REGISTERED IN BLOCKCHAIN AND NOT IN FIREBASE
    ...
    //IF IS REGISTERED IN FIREBASE AND NOT IN THE BLOCKCHAIN
  ...
  * @param {String} fullName Business full name
  ...
  * Create registry
  * @param {String} cardId Card id to connect to network
  * @param {String} degreeId id string of the registry(degree)
  * @param {String} graduateRut of the owner of the degree
  * @param {String} owner - of the degree again //REVISAR ESTO!
  * @param {String} degreeType -
  * @param {String} degreeStatus - incomplete, completed, etc
  * @param {String} major full name of the major
  * @param {String} minor full name of the minor (optional)
  * @param {String} startYear when the user started to study
  * @param {String} gradYear when the user finished his studies
  * @param {String} gpa //REVISAR ESTO!
  * @param {String} universityRut of the creator of the registry
  */
 ...
 /*
  * Get all registries of graduate
  * @param {String} cardId Card id to connect to network
  * @param {String} graduateRut - identifier to get the queries
  */
 queryRegistries: async function(cardId, graduateRut) {
  ...
  try {
   ...
   const allRegistries = await businessNetworkConnection.query('getDegreeByGraduateRut', {
 ...
 /*
  * Query all registries belonging to the university
  * @param {String} uid to get the connection card
  */
 queryAllRegistriesUniversities: async function(uid) {
  try {
   ...
   //query all registries from the network
 ...
 queryDegreeById: async function(degreeId, uid) {
  try {
   ...
   const degree = await businessNetworkConnection.query('getDegreeById', {
    degreeId: degreeId
   });
